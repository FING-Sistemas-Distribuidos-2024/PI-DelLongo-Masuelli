...
Para conectarse a la aplicación es necesario pertenecer a la VPN de ZeroTier de la cátedra (`network id: 159924d630305675`). Se puede acceder a la aplicación en el siguiente [enlace](http://10.230.50.2/).
